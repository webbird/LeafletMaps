...
$LANG = array(
    "f.e. '<city>, <street>'" => "z.B. '<Stadt>, <Straße>'",
    'Active' => 'Aktiv',
    ...
    'Default latitude' => 'Standard Latitude',
    'Default longitude' => 'Standard Longitude',
    ...
    'No' => 'Nein',
    'No markers yet' => 'Noch keine Marker',
    'none' => 'keiner',
    'Please note: Icons cannot be managed in this version of the LeafletMaps module.' => 'Hinweis: In dieser Version von LeafletMaps können die Icons nicht verwaltet werden.',
    'Please note: There will be no marker for the LAT/LNG you set here. This is only for the map center. If you need a marker, please add it on the [Markers] tab.' => 'Hinweis: Für die hier angegebenen Koordinaten wird kein Marker gesetzt. Es geht nur um die Zentrierung der Karte. Wenn ein Marker gebraucht wird, bitte auf dem entsprechenden Tab einen anlegen.',
    'Popup template' => 'Popup Template',
    'Really delete this marker?' => 'Diesen Marker wirklich löschen?',
    'Saved' => 'Gespeichert',
    'Search' => 'Suchen',
